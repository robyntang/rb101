# 7_convert_a_string_to_number.rb
...
#   assume all characters will benumeric.
...
#   counter = 0
#   loop do
#     number << digits[string[counter]]
#     counter += 1
#     break if counter == (string.length)
#   end
#   number.reverse!
#   number.each_with_index do |element, i|
#     number[i] = element * (10 ** i)
#   end
#   number.sum
# end
